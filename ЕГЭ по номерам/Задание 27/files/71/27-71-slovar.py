...
for i in range(int(f.readline())):
    ...
    if k not in ks:
        ks.append(k)
        ds[k] = [sw, i]  # минимальная частичная сумма с остатком countA
        ts[k] = [sw, i]  # начальная максимальная частичная сумма с остатком countA
    else:
        ts[k] = [sw, i]  # текущая частичная сумма с остатком countA
